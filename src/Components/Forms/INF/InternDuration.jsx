  ...
  return (
    <Group direction="column" position="center" align="center">
      ...
      <Chips variant="filled" multiple spacing="xl">
        <Chip value="react">Jan-June 2022 (Dual Degree/ Integrated M. Tech courses only (2022 batch))</Chip>
        <Chip value="ng">May-July 2022 (Pre-final year students of ALL courses (2023 batch))</Chip>
        <Chip value="svelte">July-Dec 2022 (M. Tech/ MBA – Business Analytics courses only (2023 batch))</Chip>
      </Chips>
    </Group>
  );
};
